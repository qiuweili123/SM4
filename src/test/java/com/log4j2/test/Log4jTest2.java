...
/**
 * @author liqiuwei
 * @create time:2016年5月11日下午6:15:37
 * @Description:测试log4j2的日志输出格式。通过设置加载指定位置的配置文件 -Dlog4j.configurationFile=path/
 * to /log4j2.xml
 */
public class Log4jTest2 extends BaseLog {
