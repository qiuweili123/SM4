...
public final class BindingBuilder {
    ...
    public static class HeadersExchangeMapConfigurer {
        ...
        public class HeadersExchangeSingleValueBindingCreator {
            ...
            public Binding exists() {
                return new Binding(destination.name, destination.type, exchange.getName(), "", createMapForKeys(this.key));
            }
    ...
    public static class TopicExchangeRoutingKeyConfigurer extends AbstractRoutingKeyConfigurer<TopicExchange> {
        ...
        public Binding with(String routingKey) {
            return new Binding(destination.name, destination.type, exchange, routingKey, Collections.<String, Object>emptyMap());
        }

        public Binding with(Enum<?> routingKeyEnum) {
            return new Binding(destination.name, destination.type, exchange, routingKeyEnum.toString(), Collections.<String, Object>emptyMap());
        }
    }
    ...
    public static class GenericArgumentsConfigurer {
        ...
        public Binding and(Map<String, Object> map) {
            return new Binding(configurer.destination.name, configurer.destination.type, configurer.exchange, routingKey, map);
        }

        public Binding noargs() {
            return new Binding(configurer.destination.name, configurer.destination.type, configurer.exchange, routingKey, Collections.<String, Object>emptyMap());
        }
    ...
    public static class DirectExchangeRoutingKeyConfigurer extends AbstractRoutingKeyConfigurer<DirectExchange> {
        ...
        public Binding withQueueName() {
            return new Binding(destination.name, destination.type, exchange, destination.name, Collections.<String, Object>emptyMap());
        }
    }
