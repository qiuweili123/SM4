...
public class RabbitListenerEndpointRegistry implements DisposableBean, SmartLifecycle {
    ...
    private static void startIfNecessary(MessageListenerContainer listenerContainer) {
        System.out.println("##listenerContainer.isAutoStartup()=" + listenerContainer.isAutoStartup());
    ...
    public void registerListenerContainer(RabbitListenerEndpoint endpoint, RabbitListenerContainerFactory<?> factory, boolean startImmediately) {
        ...
        synchronized (this.listenerContainers) {
            ...
            System.out.println("startImmediately==" + startImmediately);
    ...
    public void start() {
        for (MessageListenerContainer listenerContainer : getListenerContainers()) {
            System.out.println("listenerContainer==" + listenerContainer.getPhase());
            if (listenerContainer.isAutoStartup()) {
