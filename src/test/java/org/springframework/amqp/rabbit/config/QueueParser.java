...
public class QueueParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        if (!NamespaceUtils.isAttributeDefined(element, NAME_ATTRIBUTE)) {
            ...
            if (attributeHasIllegalOverride(element, DURABLE_ATTRIBUTE, "false") || attributeHasIllegalOverride(element, EXCLUSIVE_ATTRIBUTE, "true") || attributeHasIllegalOverride(element, AUTO_DELETE_ATTRIBUTE, "true")) {
        ...
        if (argumentsElement != null) {
            ...
            Map<?, ?> map = parserContext.getDelegate().parseMapElement(argumentsElement, builder.getRawBeanDefinition());
