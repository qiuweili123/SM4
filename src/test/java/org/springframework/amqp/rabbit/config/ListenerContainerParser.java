...
class ListenerContainerParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        for (int i = 0; i < childElements.size(); i++) {
            parseListener(childElements.get(i), element, parserContext, i, childElements.size() > 1);
        }
    ...
    private void parseListener(Element listenerEle, Element containerEle, ParserContext parserContext, int index, boolean multipleElements) {
