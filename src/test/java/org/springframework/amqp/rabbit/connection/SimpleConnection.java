...
public class SimpleConnection implements Connection {
    ...
    public boolean isOpen() {
        return delegate != null && (delegate.isOpen() || this.delegate.getClass().getSimpleName().contains("AutorecoveringConnection"));
    }

    @Override
    public String toString() {
        return "SimpleConnection@" + ObjectUtils.getIdentityHexString(this) + " [delegate=" + delegate + "]";
    }
