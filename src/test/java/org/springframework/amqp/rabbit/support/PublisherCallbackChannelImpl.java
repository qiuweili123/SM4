...
public class PublisherCallbackChannelImpl implements PublisherCallbackChannel, ConfirmListener, ReturnListener, ShutdownListener {
    ...
    private final Map<Listener, SortedMap<Long, PendingConfirm>> pendingConfirms = new ConcurrentHashMap<Listener, SortedMap<Long, PendingConfirm>>();
    ...
    public PublisherCallbackChannelImpl(Channel delegate) {
        ...
        ReflectionUtils.doWithMethods(delegate.getClass(), new MethodCallback() {
            ...
            public void doWith(java.lang.reflect.Method method) throws IllegalArgumentException, IllegalAccessException {
                if ("getFlow".equals(method.getName()) && method.getParameterTypes().length == 0 && FlowOk.class.equals(method.getReturnType())) {
                    getFlowMethod.set(method);
                } else if ("flow".equals(method.getName()) && method.getParameterTypes().length == 1 && boolean.class.equals(method.getParameterTypes()[0]) && FlowOk.class.equals(method.getReturnType())) {
                    flowMethod.set(method);
                } else if ("flowBlocked".equals(method.getName()) && method.getParameterTypes().length == 0 && boolean.class.equals(method.getReturnType())) {
                    flowBlockedMethod.set(method);
                } else if ("basicConsume".equals(method.getName()) && method.getParameterTypes().length == 4 && String.class.equals(method.getParameterTypes()[0]) && boolean.class.equals(method.getParameterTypes()[1]) && Map.class.equals(method.getParameterTypes()[2]) && Consumer.class.equals(method.getParameterTypes()[3]) && String.class.equals(method.getReturnType())) {
                    basicConsumeFourArgsMethod.set(method);
                } else if ("basicQos".equals(method.getName()) && method.getParameterTypes().length == 2 && int.class.equals(method.getParameterTypes()[0]) && boolean.class.equals(method.getParameterTypes()[1]) && void.class.equals(method.getReturnType())) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void basicQos(int prefetchCount, boolean global) throws IOException {
        if (this.basicQosTwoArgsMethod != null) {
            ReflectionUtils.invokeMethod(this.basicQosTwoArgsMethod, this.delegate, prefetchCount, global);
            return;
        }
    ...
    public String basicConsume(String queue, boolean autoAck, Map<String, Object> arguments, Consumer callback) throws IOException {
        if (this.basicConsumeFourArgsMethod != null) {
            return (String) ReflectionUtils.invokeMethod(this.basicConsumeFourArgsMethod, this.delegate, queue, autoAck, arguments, callback);
        }
