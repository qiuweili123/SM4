...
public class MessagingMessageConverter implements MessageConverter, InitializingBean {
    ...
    public Object fromMessage(org.springframework.amqp.core.Message message) throws MessageConversionException {
        ...
        MessageBuilder<Object> builder = (convertedObject instanceof Message) ? MessageBuilder.fromMessage((Message<Object>) convertedObject) : MessageBuilder.withPayload(convertedObject);
