...
/**
 * An instance of <tt>MyConfiguration</tt> allows the application
 * to specify properties and mapping documents to be used when
 * creating a <tt>SessionFactory</tt>. Usually an application will create
 * a single <tt>MyConfiguration</tt>, build a single instance of
 * <tt>SessionFactory</tt> and then instantiate <tt>Session</tt>s in
 * threads servicing client requests. The <tt>MyConfiguration</tt> is meant
 * only as an initialization-time object. <tt>SessionFactory</tt>s are
 * immutable and do not retain any association back to the
 * <tt>MyConfiguration</tt>.<br>
 * <br>
 * A new <tt>MyConfiguration</tt> will use the properties specified in
...
public class MyConfiguration extends Configuration implements Serializable {
    ...
    private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class, MyConfiguration.class.getName());
    /**
...
//		componentTuplizerFactory = new ComponentTuplizerFactory();
     ...
     *                          the non-cached file.
     */
    public MyConfiguration addCacheableFile(File xmlFile) throws MappingException {
     ...
     */
    public MyConfiguration addCacheableFileStrictly(File xmlFile) throws SerializationException, FileNotFoundException {
     ...
     */
    public MyConfiguration addCacheableFile(String xmlFile) throws MappingException {
     ...
     * @return this (for method chaining purposes)
     * @throws MappingException Indicates problems parsing the
     *                          given XML string
     */
     ...
     *                          the mapping document.
     */
    public MyConfiguration addDocument(org.w3c.dom.Document doc) throws MappingException {
     ...
     */
    public MyConfiguration addInputStream(InputStream xmlInputStream) throws MappingException {
     ...
     *                          processing the contained mapping document.
     */
    public MyConfiguration addResource(String resourceName, ClassLoader classLoader) throws MappingException {
     ...
     *                          processing the contained mapping document.
     */
    public MyConfiguration addResource(String resourceName) throws MappingException {
        LOG.readingMappingsFromResource(resourceName);
     ...
     *                          processing the contained mapping document.
     */
    public MyConfiguration addClass(Class persistentClass) throws MappingException {
     ...
     */
    public MyConfiguration addPackage(String packageName) throws MappingException {
        LOG.debugf("Mapping Package %s", packageName);
        try {
            MyAnnotationBinder.bindPackage(packageName, createMappings());
            return this;
    ...
    protected void secondPassCompile() throws MappingException {
        ...
        //process default values first
        {
            if (!isDefaultProcessed) {
                ...
                MyAnnotationBinder.bindDefaults(createMappings());
    ...
    protected ExtendsQueueEntry findPossibleExtends() {
        ...
        while (itr.hasNext()) {
            ...
            boolean found = getClassMapping(entry.getExplicitName()) != null || getClassMapping(HbmBinder.getClassName(entry.getExplicitName(), entry.getMappingPackage())) != null;
            if (found) {
                itr.remove();
                return entry;
            }
     ...
     * {@link SessionFactory} will be immutable, so changes made to {@code this} {@link MyConfiguration} after
     ...
     * @see #doConfigure(InputStream, String)
     */
     ...
     * @throws HibernateException Generally indicates we cannot find the named resource
     */
    protected InputStream getMyConfigurationInputStream(String resource) throws HibernateException {
     ...
     * the stream contents represent an XML document conforming to the Hibernate MyConfiguration DTD.  See
     ...
     */
    protected MyConfiguration doConfigure(InputStream stream, String resourceName) throws HibernateException {
        try {
     ...
     */
    public MyConfiguration configure(org.w3c.dom.Document document) throws HibernateException {
        LOG.configuringFromXmlDocument();
        return doConfigure(xmlHelper.createDOMReader().read(document));
    }

    /**
     * Parse a dom4j document conforming to the Hibernate MyConfiguration DTD (<tt>hibernate-configuration-3.0.dtd</tt>)
     * and use its information to configure this {@link MyConfiguration}'s state
     *
     * @param doc The dom4j document
     * @return this for method chaining
     * @throws HibernateException Indicates a problem performing the configuration task
     */
    protected MyConfiguration doConfigure(Document doc) throws HibernateException {
     ...
     * @return this for method chaining
     */
    public MyConfiguration setCacheConcurrencyStrategy(String entityName, String concurrencyStrategy) {
     ...
     * @return this for method chaining
     */
    public MyConfiguration setCacheConcurrencyStrategy(String entityName, String concurrencyStrategy, String region) {
     ...
     * @return this for method chaining
     */
    public MyConfiguration setCollectionCacheConcurrencyStrategy(String collectionRole, String concurrencyStrategy) {
...
//		settings.setComponentTuplizerFactory( this.getComponentTuplizerFactory() );
    ...
    private List<MetadataSourceType> determineMetadataSourcePrecedence() {
        if (metadataSourcePrecedence.isEmpty() && StringHelper.isNotEmpty(getProperties().getProperty(ARTEFACT_PROCESSING_ORDER))) {
    ...
    /**
     * Internal implementation of the Mappings interface giving access to the MyConfiguration's internal
     * <tt>metadata repository</tt> state ({@link MyConfiguration#classes}, {@link MyConfiguration#tables}, etc).
     */
    ...
    protected class MappingsImpl implements ExtendedMappings, Serializable {
        ...
        public boolean useNewGeneratorMappings() {
            if (useNewGeneratorMappings == null) {
                final String booleanName = getMyConfigurationProperties().getProperty(AvailableSettings.USE_NEW_ID_GENERATOR_MAPPINGS);
        ...
        public boolean useNationalizedCharacterData() {
            if (useNationalizedCharacterData == null) {
                final String booleanName = getMyConfigurationProperties().getProperty(AvailableSettings.USE_NATIONALIZED_CHARACTER_DATA);
        ...
        public boolean forceDiscriminatorInSelectsByDefault() {
            if (forceDiscriminatorInSelectsByDefault == null) {
                final String booleanName = getMyConfigurationProperties().getProperty(AvailableSettings.FORCE_DISCRIMINATOR_IN_SELECTS_BY_DEFAULT);
        ...
        public void addJoins(PersistentClass persistentClass, Map<String, Join> joins) {
            Object old = MyConfiguration.this.joins.put(persistentClass.getEntityName(), joins);
            if (old != null) {
        ...
        public Map<Table, List<String[]>> getTableUniqueConstraints() {
            final Map<Table, List<String[]>> deprecatedStructure = new HashMap<Table, List<String[]>>(CollectionHelper.determineProperSizing(getUniqueConstraintHoldersByTable()), CollectionHelper.LOAD_FACTOR);
            for (Map.Entry<Table, List<UniqueConstraintHolder>> entry : getUniqueConstraintHoldersByTable().entrySet()) {
                List<String[]> columnsPerConstraint = new ArrayList<String[]>(CollectionHelper.determineProperSizing(entry.getValue().size()));
        ...
        private class TableColumnNameBinding implements Serializable {
            ...
            private void bindLogicalToPhysical(String logicalName, Column physicalColumn) throws DuplicateMappingException {
                ...
                if (existingPhysicalName != null) {
                    ...
                    if (!areSamePhysicalColumn) {
                        throw new DuplicateMappingException(" Table [" + tableName + "] contains logical column name [" + logicalName + "] referenced by multiple physical column names: [" + existingPhysicalName + "], [" + physicalName + "]", "column-binding", tableName + "." + logicalName);
                    }
                }
            }
            ...
            private void bindPhysicalToLogical(String logicalName, Column physicalColumn) throws DuplicateMappingException {
                ...
                if (existingLogicalName != null && !existingLogicalName.equals(logicalName)) {
                    throw new DuplicateMappingException(" Table [" + tableName + "] contains phyical column name [" + physicalName + "] represented by different logical column names: [" + existingLogicalName + "], [" + logicalName + "]", "column-binding", tableName + "." + physicalName);
                }
            }
        }
    }
    ...
    final class ObjectNameNormalizerImpl extends ObjectNameNormalizer implements Serializable {
        public boolean isUseQuotedIdentifiersGlobally() {
            //Do not cache this value as we lazily set it in Hibernate Annotation (AnnotationMyConfiguration)
            //TODO use a dedicated protected useQuotedIdentifier flag in MyConfiguration (overriden by AnnotationMyConfiguration)
    ...
    protected class MetadataSourceQueue implements Serializable {
        ...
        private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
            ...
            @SuppressWarnings("unchecked") List<Class> serializableAnnotatedClasses = (List<Class>) ois.readObject();
        ...
        private void processAnnotatedClassesQueue() {
            ...
            Map<XClass, InheritanceState> inheritanceStatePerClass = MyAnnotationBinder.buildInheritanceStates(orderedClasses, mappings);


            for (XClass clazz : orderedClasses) {
                MyAnnotationBinder.bindClass(clazz, inheritanceStatePerClass, mappings);
