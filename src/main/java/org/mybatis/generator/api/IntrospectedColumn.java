...
//    }
    ...
    @Override
    public String toString() {
        return "IntrospectedColumn [actualColumnName=" + actualColumnName + ", jdbcType=" + jdbcType + ", jdbcTypeName=" + jdbcTypeName + ", nullable=" + nullable + ", length=" + length + ", scale=" + scale + ", identity=" + identity + ", isSequenceColumn=" + isSequenceColumn + ", javaProperty=" + javaProperty + ", fullyQualifiedJavaType=" + fullyQualifiedJavaType + ", tableAlias=" + tableAlias + ", typeHandler=" + typeHandler + ", context=" + context + ", isColumnNameDelimited=" + isColumnNameDelimited + ", introspectedTable=" + introspectedTable + ", properties=" + properties + ", remarks=" + remarks + ", defaultValue=" + defaultValue + "]";
    }
