...
import static org.mybatis.generator.internal.util.JavaBeansUtil.getDomainObjectNameString;
...
public class FullyQualifiedTable {
     ...
     * 删除类名的前缀
     */
    private String delEntityPreFix;
     ...
     *                                  Context.
     */
    public FullyQualifiedTable(String introspectedCatalog, String introspectedSchema, String introspectedTableName, String domainObjectName, String alias, boolean ignoreQualifiersAtRuntime, String runtimeCatalog, String runtimeSchema, String runtimeTableName, boolean delimitIdentifiers, String delEntityPreFix, Context context) {
        super();
        ...
        if (stringHasValue(delEntityPreFix)) {
            this.delEntityPreFix = delEntityPreFix;
        }
    ...
    public String getDelEntityPreFix() {
        return delEntityPreFix;
    }
    ...
    public String getDomainObjectName() {
        String entityName;
        if (stringHasValue(domainObjectName)) {
            entityName = domainObjectName;
        } else if (stringHasValue(runtimeTableName)) {
            entityName = getCamelCaseString(runtimeTableName, true);
        } else {
            entityName = getCamelCaseString(introspectedTableName, true);
        }
        entityName = getDomainObjectNameString(entityName, delEntityPreFix);
        System.out.println("正在生成实体：" + entityName + ".......");
        return entityName;
    }
