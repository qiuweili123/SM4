...
public class JavaBeansUtil {
    ...
    public static String getDomainObjectNameString(String objectName, String delEntityPreFix) {
        if (StringUtility.stringHasValue(delEntityPreFix)) {
            return objectName.replace(delEntityPreFix, "");
        } else {
            return objectName;
        }
    }
