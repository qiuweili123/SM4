...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseTable(Context context, Node node) {
        ...
        String delEntityPreFix = attributes.getProperty("delEntityPreFix"); //$NON-NLS-1$
        ...
        String generalSequenceGenerator = attributes.getProperty("generalSequenceGenerator");
        ...
        if (stringHasValue(delEntityPreFix)) {
            tc.setDelEntityPreFix(delEntityPreFix);
        }

        if (stringHasValue(generalSequenceGenerator)) {
            tc.setGeneralSequenceGenerator(generalSequenceGenerator);
        }
    ...
    private void parseJdbcConnection(Context context, Node node) {
        ...
        String remarksReporting = attributes.getProperty("remarksReporting"); //add oracle gen comment
