...
public class TableConfiguration extends PropertyHolder {
     ...
     * 通用sequece生成器
     */
    private String generalSequenceGenerator;
    ...
    public String getGeneralSequenceGenerator() {
        return generalSequenceGenerator;
    }

    public void setGeneralSequenceGenerator(String generalSequenceGenerator) {
        this.generalSequenceGenerator = generalSequenceGenerator;
    }
    ...
    public void setDelEntityPreFix(String delEntityPreFix) {
